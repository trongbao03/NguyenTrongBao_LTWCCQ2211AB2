      ...
      <div id="carouselExample" class="carousel slide">
         <div class="carousel-inner">
            <div class="carousel-item active">
               <img src="/Website/NguyenTrongBao_CCQ2211AB/public/images/banner/slider_1.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
               <img src="/Website/NguyenTrongBao_CCQ2211AB/public/images/banner/slider_2.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
               <img src="/Website/NguyenTrongBao_CCQ2211AB/public/images/banner/slider_3.jpg" class="d-block w-100" alt="...">
            </div>
         </div>
            ...
            <div class="row">
               <div class="col-md-3">
                  <div class="category-title bg-main">
                     ...
                     <img class="img-fluid d-none d-md-block" src="/Website/NguyenTrongBao_CCQ2211AB/public/images/category/thoi-trang-nam.png"
                        alt="category.jpg">
                  </div>
               </div>
               <div class="col-md-9">
                           ...
                           <div class="product-item-image">
                              <a href="product_detail.html">
                                 <img src="/Website/NguyenTrongBao_CCQ2211AB/public/images/product/thoi-trang-nam-1.jpg" class="img-fluid" alt=""
                                    id="img1">
                                 <img class="img-fluid" src="/Website/NguyenTrongBao_CCQ2211AB/public/images/product/thoi-trang-nam-2.jpg" alt=""
                                    id="img2">
                              </a>
                           </div>
            ...
            <div class="row">
               <div class="col-md-3">
                  <div class="category-title bg-main">
                     ...
                     <img class="img-fluid d-none d-md-block" src="/Website/NguyenTrongBao_CCQ2211AB/public/images/category/thoi-trang-nu.png" alt="">
                  </div>
               </div>
               <div class="col-md-9">
                  <div class="row product-list">
                     <div class="col-6 col-md-3 mb-4">
                        <div class="product-item border">
                           <div class="product-item-image">
                              <a href="product_detail.html">
                                 <img src="/Website/NguyenTrongBao_CCQ2211AB/public/images/product/thoi-trang-nu-1.jpg" class="img-fluid" alt=""
                                    id="img1">
                                 <img class="img-fluid" src="/Website/NguyenTrongBao_CCQ2211AB/public/images/product/thoi-trang-nu-2.jpg" alt=""
                                    id="img2">
                              </a>
                           </div>
                           <h2 class="product-item-name text-main text-center fs-5 py-1">
            ...
            <div class="row">
               <div class="col-md-3">
                  <div class="category-title bg-main">
                     ...
                     <img class="img-fluid d-none d-md-block" src="/Website/NguyenTrongBao_CCQ2211AB/public/images/category/thoi-trang-tre-em.png"
                        alt="">
                  </div>
               </div>
               <div class="col-md-9">
                  <div class="row product-list">
                     <div class="col-6 col-md-3 mb-4">
                        <div class="product-item border">
                           <div class="product-item-image">
                              <a href="product_detail.html">
                                 <img src="/Website/NguyenTrongBao_CCQ2211AB/public/images/product/thoi-trang-tre-em-1.webp" class="img-fluid" alt=""
                                    id="img1">
                                 <img class="img-fluid" src="/Website/NguyenTrongBao_CCQ2211AB/public/images/product/thoi-trang-tre-em-2.webp" alt=""
                                    id="img2">
                              </a>
                           </div>
                           <h2 class="product-item-name text-main text-center fs-5 py-1">
            ...
            <div class="row">
               <div class="col-md-3">
                  <div class="category-title bg-main">
                     ...
                     <img class="img-fluid d-none d-md-block" src="/Website/NguyenTrongBao_CCQ2211AB/public/images/category/thoi-trang-the-thao.png"
                        alt="">
                  </div>
               </div>
               <div class="col-md-9">
                  <div class="row product-list">
                     <div class="col-6 col-md-3 mb-4">
                        <div class="product-item border">
                           <div class="product-item-image">
                              <a href="product_detail.html">
                                 <img src="/Website/NguyenTrongBao_CCQ2211AB/public/images/product/thoi-trang-the-thao-1.webp" class="img-fluid" alt=""
                                    id="img1">
                                 <img class="img-fluid" src="/Website/NguyenTrongBao_CCQ2211AB/public/images/product/thoi-trang-the-thao-2.webp" alt=""
                                    id="img2">
                              </a>
                           </div>
                           <h2 class="product-item-name text-main text-center fs-5 py-1">
               ...
               <div class="row">
                  <div class="col-md-6">
                     <a href="post_detail.html">
                        <img class="img-fluid" src="/Website/NguyenTrongBao_CCQ2211AB/public/images/post/post-4.webp" />
                     </a>
                  ...
                  <div class="col-md-6">
                     <div class="row mb-3">
                        <div class="col-md-4">
                           <a href="post_detail.html">
                              <img class="img-fluid" src="/Website/NguyenTrongBao_CCQ2211AB/public/images/post/post-1.jpg" />
                           </a>
                        </div>
                        <div class="col-md-8">
                     ...
                     <div class="row mb-3">
                        <div class="col-md-4">
                           <a href="post_detail.html">
                              <img class="img-fluid" src="/Website/NguyenTrongBao_CCQ2211AB/public/images/post/post-2.jpg" />
                           </a>
                        </div>
                        <div class="col-md-8">
                           <h3 class="post-title fs-5">
                     ...
                     <div class="row mb-3">
                        <div class="col-md-4">
                           <a href="post_detail.html">
                              <img class="img-fluid" src="/Website/NguyenTrongBao_CCQ2211AB/public/images/post/post-3.jpg" />
                           </a>
                        </div>
                        <div class="col-md-8">
                           <h3 class="post-title fs-5">
