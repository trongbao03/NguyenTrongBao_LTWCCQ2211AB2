<div class="product-item border">
    <div class="product-item-image">
        ...
        <img src="/Website/NguyenTrongBao_CCQ2211AB/public/images/product/<?=$product->image;?>" class="img-fluid" alt="<?=$product->image;?>"
      id="img1">
        <img class="img-fluid" src="/Website/NguyenTrongBao_CCQ2211AB/public/images/product/<?=$product->image;?>" alt="<?=$product->image;?>"id="img2">
        </a>
    </div>
